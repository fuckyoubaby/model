...
public class DownloadFileUtil {
	...
	public static void DownloadFileUtil(HttpServletRequest request, HttpServletResponse response,String path)
	{
       ...
       response.setHeader( "Accept-Ranges", "bytes" );// 如果是第一次下,还没有断点续传,状态是默认的 200,无需显式设置;响应的格式是:HTTP/1.1 200 OK
        ...
        try {
            ...
            response.setContentType(DownloadUtil. setContentType(downloadFile.getName())); // set the MIME type.
