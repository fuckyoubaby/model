...
public class AppPhoneManage extends EntityBase{
	...
	public AppPhoneManage(){
		
	}

	public AppPhoneManage(String appName,String appType,String appVersion,String appVersionInfo,String appFileUrl){
