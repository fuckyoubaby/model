...
public class AppPhoneManageDTO implements Serializable {
	...
	public AppPhoneManageDTO(){
		
	}
	
	public AppPhoneManageDTO(String uuid,String appName,String appType,String appVersion,String appVersionInfo,String appFileUrl,boolean appEnabled){
		this.uuid = uuid;
