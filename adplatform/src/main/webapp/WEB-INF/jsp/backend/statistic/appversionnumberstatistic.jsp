...
<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <div class="nNote nInformation hideit">
            <p><strong>提示: </strong>下面显示了所有的地区目录，点击地区目录，可以查看相应目录下的应用版本数据的统计</p>
        </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/ch/sta/appversionnumbersta.js"></script>
