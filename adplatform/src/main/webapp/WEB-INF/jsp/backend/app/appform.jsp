...
<div id="rightSide">
    ...
    <%--主要内容*******************************************************--%>
    <div class="wrapper">
        <spring-form:form commandName="appManage" method="POST" enctype="multipart/form-data" cssClass="form">
            <fieldset>
                <div class="widget">
                    <div class="title">
                        ...
                        <h6>
                            <c:choose>
                                <c:when test="${appManage.uuid != null && appManage.uuid !=''}">
                                   终端应用编辑
                                </c:when>
                                <c:otherwise>
                                   终端应用添加
                    ...
                    <input type="hidden" name="appUuid" value="${appManage.uuid}"/>
                    <div class="formRow">
                    ...
                    <div class="formSubmit">
                        <input type="button" value="返回" class="greenB" onclick="window.location.href='${pageContext.request.contextPath}/backend/appmanagement.html?filterName=${filterName}&current=${current}'"/>
