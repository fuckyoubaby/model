            ...
            jQuery("#userenable-dialog-confirm").dialog({
                    ...
                    buttons: {
                        "确认": function() {
                            ...
                            window.location.href = '${pageContext.request.contextPath}/backend/appphonestatus.html?appUuid=' + appUuid + '&filterName=' + filterName + '&current=' + current;
                        },
                        "取消": function() {
                            jQuery("#userenable-dialog-confirm").css("visibility", "hidden");
                            jQuery(this).dialog("close");
...
<div id="rightSide">
    ...
    <div class="nNote nInformation hideit">
        <p><strong>手机应用管理: </strong>对手机应用进行添加，编辑和删除操作</p>
    </div>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            <div class="title">
                ...
                <h6>应用名:</h6>
                <form action="${pageContext.request.contextPath}/backend/appphonemanagement.html" method="POST" style="padding-top:4px;">
                ...
                <a class="button greyishB" title="" href="#" style="position: absolute; top: 5px; right: 5px;"
                   onclick="window.location.href = '${pageContext.request.contextPath}/backend/appphoneform.html'">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable">
                ...
                <tbody>
                    <c:forEach items="${Apps}" var="appPhoneManage" varStatus="counter">
                    <tr class="gradeX">
                        <td style="text-align: center;">${counter.count}</td>
                        <td style="text-align: center;">${appPhoneManage.appName}</td>
                        <td style="text-align: center;">${appPhoneManage.appType}</td>
                        <td style="text-align: center;">${appPhoneManage.appVersion}</td>
                        <td style="text-align: center;">${appPhoneManage.appVersionInfo}</td>
                        <%-- <td> 
                        ...
                        <td style="text-align: center;">
                            <c:if test="${appPhoneManage.appEnabled}">
                                在用
                            </c:if>
                            <c:if test="${!appPhoneManage.appEnabled}">
                                停用
                        ...
                        <td style="text-align: center;">
                            <a class="button blueB" title="" href="#"
                               onclick="window.location.href='${pageContext.request.contextPath}/backend/appphoneform.html?appUuid=${appPhoneManage.uuid}&filterName=${filterName}&current=${current}'">
                                <span>编辑</span>
                            </a>
                            <c:if test="${appPhoneManage.appEnabled}">
                                <a class="button redB" title="" href="#" onclick="return appDeleteConfirm('${appPhoneManage.uuid}', '${filterName}', '${current}');">
                                    <span>停用</span>
                                </a>
                            </c:if>
                            <c:if test="${!appPhoneManage.appEnabled}">
                                <a class="button greenB" title="" href="#" onclick="return appEnableConfirm('${appPhoneManage.uuid}', '${filterName}', '${current}');">
                                    <span>激活</span>
                                </a>
                            </c:if>
                      </td>
